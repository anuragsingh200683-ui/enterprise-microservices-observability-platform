...
// Intentionally duplicated in employee-service's exception package rather than extracted to a
// shared module: each service builds from its own standalone Docker context (docker build
// ./project-service), so a shared module would need to be resolvable from Maven Central/a
